...
class RandomGenerator_BraTS(object):
    def __init__(self):
    ...
    def __call__(self, sample):
        ...
        #     image = ndimage.zoom(image, (self.output_size[0] / x, self.output_size[1] / y), order=3)  # why not 3?
...
class Brats_SR(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.transform:
            D_T2, T2, PD = self.transform((t2_downsampled, t2_img, t1_img))
        else:
            D_T2, T2, PD = t2_downsampled, t2_img, t1_img
